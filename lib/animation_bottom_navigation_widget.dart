...
class _TileIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final IconThemeData iconThemeData = IconThemeDataA.lerp(
    ...
    final IconThemeData unIconThemeData = IconThemeDataA.lerpColor(
      // defaultIconTheme.merge(unselectedIconTheme),
      // defaultIconTheme.merge(selectedIconTheme),
      unselectedIconTheme,
      selectedIconTheme,
    ...
    return Align(
      ...
      child: Container(
        child: IconTheme(
          data: selected?iconThemeData:unIconThemeData,
